    ...
    const [showVoiceModal, setShowVoiceModal] = useState(false);
      ...
      return (
        <div className="space-y-6">
          {/* Header */}
          <div
            className="rounded-xl p-4 flex justify-between items-center bg-white border-2 shadow-sm"
            style={{
              borderColor: currentProduct?.color || "#22c55e",
            }}
          >
            <h1
              className="md:text-2xl text-[1.4rem] font-extrabold"
              style={{ color: currentProduct?.color || "#22c55e" }}
            >
              {currentProduct?.name}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-4 shadow relative border-l-4 border-zinc-600">
              <h2 className="font-bold text-lg text-gray-700">Produced</h2>
              <p className="text-3xl font-extrabold text-zinc-700 mt-2">
                {totalProduced}
              </p>
              ...
              <button
                ...
                className="absolute top-4 right-4 text-gray-400 hover:text-zinc-700"
            ...
            <div className="bg-white rounded-xl p-4 shadow relative border-l-4 border-indigo-900">
              <h2 className="font-bold text-lg text-gray-700">Sold</h2>
            ...
            >
              <h2 className="font-bold text-lg text-gray-700">Remaining</h2>
              <p
          ...
          <div className="flex flex-wrap gap-4 font-semibold">
            <button
              ...
              className="flex items-center gap-2 bg-zinc-700 hover:bg-zinc-800 text-white px-4 py-2 rounded-lg shadow transition"
            >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-5">
                  <div
                    className="bg-zinc-600 h-5 rounded-full transition-all duration-500"
              ...
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-5">
                  <div
                    className="bg-indigo-900 h-5 rounded-full transition-all duration-500"
