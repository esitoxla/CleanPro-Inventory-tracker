...
export default function ProductManagement() {
  ...
  return (
    <div className="p-2 space-y-6">
      <h1 className="text-3xl font-bold text-[#223962]">
      ...
      <form
        ...
        className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex flex-col md:flex-row gap-4 items-end"
      >
        ...
        {!editingId && (
          <div className="w-full md:w-48">
            ...
            <select
              ...
              className="border p-3 rounded-lg w-full capitalize"
            >
        ...
        {editingId && (
          <button
            type="button"
            onClick={resetForm}
            className="text-gray-500 hover:text-gray-700 font-semibold py-3 px-4"
          >
            Cancel
          </button>
        )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white rounded-xl shadow-md p-4 flex flex-col gap-3 border-l-4"
          ...
          >
            ...
            <button
              ...
              className="bg-[#223962] hover:bg-[#1a2c4d] text-white font-semibold py-2 px-4 rounded-lg transition-all mt-auto"
            >
              Open Dashboard →
            </button>
          </div>
